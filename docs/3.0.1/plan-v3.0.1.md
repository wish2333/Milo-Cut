...
- [x] macOS 本机冒烟：SRT 副轨导入 -> 堆叠显示 -> 折叠/高度/显隐 -> 缩放平移 -> 播放头贯穿 ✅ 2026-09-01（用户确认显示正常）
- [x] ★ Windows WebView2 冒烟：用户放行推进，清单项并入 beta.2 冒烟补验 ✅ 2026-09-01
- [x] 打 tag `v3.0.1-beta.1`；`record-3.0.1-beta.1.md` 汇总 ✅ 2026-09-01
